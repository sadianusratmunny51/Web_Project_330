  ...
  requests.forEach((req) => {
    ...
    const card = `
      <div class="request-card">
        ...
        <div class="left-info">
          <p><span><i class="fa-solid fa-location-dot" style="color:#6f42c1;"></i>User id: </span> ${req.id}</p>
          <p><span><i class="fa-solid fa-location-dot" style="color:#6f42c1;"></i>User id: </span> ${req.user_id}</p>
